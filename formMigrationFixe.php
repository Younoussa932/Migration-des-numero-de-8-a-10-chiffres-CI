        ...
        <form action="" method="post">
            <div class="form-row mt-5">
                ...
                <div class="form-group col-md-5">
                    ...
                    <input type="text" name="nvo_numero" id="nvo_numero" class="form-control" value="<?php if($nvo_numero != null) echo $nvo_numero;  ?>" readonly>
                </div>
                <div class="form-group">
                    <button class="btn btn-primary" name="sms">Convertir</button>
                </div>
            </div>
        </form>
    </div>
